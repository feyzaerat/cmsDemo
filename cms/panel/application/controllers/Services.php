...
class Services extends VS_Controller
{
    ...
    public function index(){
        ...
        $items = $this->ServiceModel->getAll(
            array(), "rank ASC"
        );
    ...
    public function save(){
        ...
        $this->load->library("form_validation");
            ...
            if($_FILES["img_url"]["name"] == ""){
                ...
                redirect(base_url("Services/NewForm"));
                die();
    ...
    public function update($id){
        ...
        if($validate) {
            ...
            $update = $this->ServiceModel->update(array("id" => $id), $data);
            ...
            $vData->item = $this->ServiceModel->get(
                array(
                    "id"    => $id,
                )
            );
    ...
    public function delete($id){
        ...
        $delete = $this->ServiceModel->delete(
            array(
                "id"    => $id
            )
        );
