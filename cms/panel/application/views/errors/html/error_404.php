...
<title>404 Page Not Found</title>
    ...
    <script rel="script" src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.1.1/gsap.min.js"></script>
    <link rel="stylesheet" href="<?php echo base_url("assets/"); ?>css/error_404.scss">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css">

</head>

<body>
<main id="app-main" class="app-main" style="margin:10vw;">
    <div class="wrap">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                ...
                <a style="color: #5b5a5a; background: #b3bdbd" class="btn green" href="<?php echo base_url('')?>" >HOME</a>
            </div>
        </div>
    </div>
        </section>
