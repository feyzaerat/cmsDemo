<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            ...
            <a href="<?php echo base_url("add-new-service"); ?>" class="add btn  btn-xs pull-right"> <i class="fa fa-plus"></i> <?php echo lang('add-new')?></a>
            <?php }?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget p-b-xl "  style="overflow-x:auto;">
            ...
            <?php if(empty($items)) { ?>
                ...
                <div class="alert alert-info text-center">
                    <p><?php echo lang('no-data')?> <?php echo lang('for-add')?> <a href="<?php echo base_url("add-new-service"); ?>"><?php echo lang('click-here')?></a></p>
                </div>
                               ...
                               <!-- <td><?php echo $item->img_url; ?></td>-->
                                ...
                                <td>
                                    ...
                                    <?php if (isAllowedUpdateModule()){?>
                                        <a title="<?php echo lang('update')?>" href="<?php echo base_url("Services/updateForm/$item->id"); ?>" class="btn btn-sm btn-info  prdctBtn"><i class="fa fa-pencil-square-o"></i> </a>
                                    <?php }?>
                                </td>
                            </tr>
