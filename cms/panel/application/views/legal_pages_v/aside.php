    ...
    <div class="menubar-scroll">
        <div class="menubar-scroll-inner">
            <ul class="app-menu">
                ...
                <?php }?>
                <?php if(isAllowedViewModule("Slider")){?>
                <li>
                    <a href="<?php echo base_url("Slider"); ?>">
                        <i class="menu-icon zmdi zmdi-layers zmdi-hc-lg"></i>
                        <span class="menu-text"><?php echo lang('slider')?></span>
                    </a>
                </li>
                <?php }?>
                ...
                <?php if(isAllowedViewModule("Orders")){?>
                    <li>
                        <a href="<?php echo base_url("Orders"); ?>">
                            ...
                            <span class="menu-text"><?php echo lang('orders')?></span>
                        </a>
                    </li>
                <?php }?>
                ...
                <li>
                    <a href="<?php echo base_url("Members"); ?>">
                        ...
                        <span class="menu-text"><?php echo lang('members')?></span>
                    </a>
                </li>
                <?php }?>
                ...
                <li>
                    <a href="<?php echo base_url("Popups"); ?>">
                        ...
                        <span class="menu-text"><?php echo lang('popup-service')?></span>
                    </a>
                </li>
                <?php }?>
