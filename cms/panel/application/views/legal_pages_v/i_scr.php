...
<!--<script src=" <?php echo cdn()."/";?>assets/js/app.min.js"></script>
<script src="<?php echo cdn()."/";?>assets/js/library.js"></script>-->
...
<!--<script src="<?php echo cdn()."/";?>assets/js/scripts.js"></script>-->
...
<!--<script src="<?php echo cdn()."/";?>assets/js/custom.js"></script>-->
